export default {
  about: {
    meta: {
      title: 'Syscoin Sentry Nodes - About Syscoin Sentry Nodes',
    ...
    title: 'Learn About Syscoin Sentry Nodes',
    masternodes: {
      question: {
        p1: 'What sets',
        p2: 'Syscoin Sentry Nodes apart?',
      },
      featureList: {
        f1: 'Z-DAG Protocol’s instant Asset transfer',
        f2: 'Scalability',
        f3: 'Facilitation of future Syscoin features and services',
        f4: 'Seniority benefits to Sentry Node operators',
      },
      description: {
        d1: 'Syscoin Sentry Nodes protect the blockchain from network attacks, in the same vein as traditional proof of stake algorithms. It’s often expensive to accumulate enough of a currency to create a Sentry Node. This expense helps keep the network decentralised, as it would take an ungodly amount of money to purchase enough currency to have a monopoly on its nodes.',
        d2: 'The cost of operating a Sentry Node also keeps operators honest. Unlike Bitcoin miners, who may switch from one coin on its blockchain to the next based on profitability, operators are incentivised to properly maintain and upkeep their Syscoin Sentry Nodes. The exorbitant initial investment serves as collateral, whereby if operators want their investment to pay off, they have to play by the blockchain’s rules. Between the high operation costs and promising return on investment, it’s in an operator’s best interest to operate his/her node properly and without any malicious intent.',
      }
    },
    governance: {
      ...
      description:{
        d1: 'Each month a pot of governance funding is generated by the Syscoin blockchain ‘superblock’. Any individual or group can submit a proposal to receive some of these funds. Sentry Node owners vote on the proposals using voting technology embedded in the Syscoin blockchain. At the end of the monthly voting period funds are distributed to the proposals with the greatest number of YES Votes. Successful projects tend to be those that support and advance Syscoin Platform, such as marketing initiatives and application development.',
    ...
    rewards: {
      ...
      question: 'How does Decentralized Governance work?',
      description: {
        d1: '75% of each regular block reward is distributed to Sentry Node operators as an incentive to continue running the node. Each payout amounts to roughly 53 SYS, though this will increase over time due to the Seniority Benefits mechanism. The likelihood of a Sentry Node receiving a payout is inversely proportional to the total number of Sentry Nodes on the network. At the time of writing, a Sentry Node is likely to receive a 53 SYS reward roughly once every 4-5 days.',
    ...
    seniority: {
      ...
      description: 'It’s been noted that Syscoin price fluctuations may in turn cause fluctuations in the number of Sentry Nodes running on the network. To mitigate this and incentivise nodes to provide services consistently for long periods of time, we have introduced a seniority mechanism that increases ROI for long-term nodes.',
      seniority: {
        s1: {
        ...
        s2: {
          title: 'Syscoin Average Block is 2.5 Minutes',
          d1: 'Therefore;',
          d2: '1 Month = 17,520 Blocks',
          d3: '1 Year Seniority = 210,240 Blocks',
          d4: '2.5 Year Seniority = 525,600 Blocks',
        },
        s3: {
          title: 'Calculating 1 Year Seniority',
          d1: 'You sent your 100,000 Syscoin at Block Height 1000.',
          d2: '210,400 + 1,000 = 211,400.',
          d3: '211,400 Block Height = Your first increase in Seniority.',
        },
        s4: {
          title: 'Calculating 2 Year Seniority',
          d1: 'You sent your 100,000 Syscoin at Block Height 1000.',
          d2: '525,600 + 1000 = 526,600',
          d3: '526,600 Block Height = Your second increase in Seniority.',
        },
      },
      note: { // check /About for more context on how to translate these..
        ...
        n2: 'Stopping your Syscoin Sentry Node, restarting your server, closing QT, upgrading Sentry Nodes, Initialising your Sentry Node, changing your IP address, and anything you can possibly think of does not effect your Seniority.',
      },
    },
    requirements: {
