...
export class Stats extends Component {
    ...
    async getStats() {
        ...
        let dates = await axios
                    .get("http://127.0.0.1:8080/mnDates")
                    .then(function(result) {
                        return result;
                    })
                    .catch(function(error) {
        ...
        if(this.state.dataload===1){
            ...
            return(
                <main className="statsPage">
                    ...
                    <AxisChart datesData={this.state.api_dates_data[0]} datal={this.state.dataload}/>
                    <AxisChart datesData={this.state.api_dates_data[1]} datal={this.state.dataload}/>
